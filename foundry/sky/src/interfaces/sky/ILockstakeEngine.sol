...
interface ILockstakeEngine {
    ...
    event Hope(
        address indexed owner, uint256 indexed index, address indexed usr
    );
    event Nope(
        address indexed owner, uint256 indexed index, address indexed usr
    );
    ...
    event Lock(
        address indexed owner, uint256 indexed index, uint256 wad, uint16 ref
    );
    event Free(
        address indexed owner,
        uint256 indexed index,
    ...
    event FreeNoFee(
        address indexed owner, uint256 indexed index, address to, uint256 wad
    );
    event Draw(
        address indexed owner, uint256 indexed index, address to, uint256 wad
    );
    ...
    event OnRemove(
        address indexed urn, uint256 sold, uint256 burn, uint256 refund
    );
    ...
    function ownerUrns(address owner, uint256 index)
        external
        view
        returns (address);
    ...
    // --- Getters ---
    function isUrnAuth(address owner, uint256 index, address usr)
        external
        view
        returns (bool);
